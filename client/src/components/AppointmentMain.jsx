...
const AppointmentMain = () => {
  ...
  return (
    <div className={`min-h-screen w-4/5 ${view ? "max-md:relative max-md:w-full" : "w-full"} flex flex-col gap-8 px-10 py-10`}>
      <div className="w-full">
        <div className="flex justify-between">
          ...
          <button
            ...
            className="bg-gray-300 px-2 py-2 mt-5 max-sm:text-sm rounded-lg cursor-pointer"
          >
            Add Appointment
          </button>
        </div>
                      ...
                      <td className="py-2 px-4 border-b border-gray-200 text-left">
                        <div className="flex max-lg:flex-col gap-1">
                          <a
                            ...
                            onClick={()=>navigate(`/editAppointments/${a._id}`)}
                          >
                            Edit
                          </a>
                          <a
